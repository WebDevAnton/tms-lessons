...
# Я при выполнении данного задания были использованы видео с ютуба, форумы и сhat gpt.
# Я выполнил все первую часть задания. Из части "Сериализация" выполнены задания номер 1,3,5
    ...
    def run(self):
        ...
        while True:
            ...
            if number == 0:
                ...
                print('Ошибка. Такую команду мы не можем выполнить =(')
